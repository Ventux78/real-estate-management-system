...
import { Calendar, Hash, MapPin, Bed, Bath, Maximize, Ruler, Home, ExternalLink } from 'lucide-react';
import { WhatsAppButton } from '@/components/properties/WhatsAppButton';
import { formatCurrency } from '@/lib/utils';
import { generatePropertyMetadata, getBaseUrl } from '@/lib/seo';
...
export default async function PropertyDetailPage({
  ...
  const breadcrumbItems = [
    ...
    { name: 'İlanlar', url: `${baseUrl}/properties` },
        ...
        <Container>
          <div className="bg-[#121212] rounded-2xl shadow-sm border border-[#333333] overflow-hidden">
            ...
            <div className="p-6 md:p-8 border-b border-[#333333] bg-[#121212]/50">
              <PropertyGallery property={property} images={property.images} title={property.title} />
            </div>
            ...
            <div className="p-6 md:p-8 grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-2 space-y-10">
                ...
                {(() => {
                  ...
                  if (property.inComplex)
                    features.push(
                      property.complexName ? `Site İçi (${property.complexName})` : 'Site İçerisinde'
                    );
                    ...
                    <section>
                      ...
                      <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                        {features.map((feature: string, idx: number) => (
                          <li
                            key={idx}
                            className="flex items-center text-[#A1A1AA] bg-[#121212] px-4 py-2 rounded-lg border border-[#333333]"
                          >
              ...
              <div className="space-y-6">
                <div className="bg-[#121212] border border-[#333333] rounded-xl p-6 shadow-sm">
                  <h3 className="text-lg font-bold text-white mb-6 pb-4 border-b border-[#333333]">
                    Özet Bilgiler
                  </h3>
                  ...
                  <div className="space-y-4">
                    ...
                    {property.wcType && (
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium text-white">
                          {wcMap[property.wcType] || property.wcType}
                        </span>
                      </div>
                    )}
                    ...
                    {property.floor !== null && property.floor !== undefined && (
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium text-white">
                          {property.floor}. Kat{' '}
                          {property.totalFloor ? `(Toplam ${property.totalFloor})` : ''}
                        </span>
                      </div>
                    )}
                    ...
                    {property.kitchenType && (
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium text-white">
                          {kitchenMap[property.kitchenType] || property.kitchenType}
                        </span>
                      </div>
                    )}
                    ...
                    {property.heatingType && (
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium text-white">
                          {heatingMap[property.heatingType] || property.heatingType}
                        </span>
                      </div>
                    )}
                    ...
                    {property.deedStatus && (
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium text-white">
                          {deedMap[property.deedStatus] || property.deedStatus}
                        </span>
                      </div>
                    )}
